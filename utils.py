...
def key_of_min_value(d):
    ...
    # an explanation as to why this works due to the behavior of min with iterables
    # https://stackoverflow.com/questions/14976031/how-does-the-python-min-function-works
    # END Question 0
